            ...
            <div className='write-body'>
                <div className='write-body-option'>
                    ...
                    <div className='write-body-option-title'>
                        <div className='write-body-option-title-name-box'>
                            <div className='write-body-option-title-name'>게시판명</div>
                        </div>
                    ...
                    <div className='write-body-option-category'>
                        <div className='write-body-option-category-name-box'>
                            <div className='write-body-option-category-name'>카테고리</div>
                        </div>
                    ...
                    <div className='write-body-option-country'>
                        <div className='write-body-option-country-name-box'>
                            <div className='write-body-option-country-name'>나라선택</div>
                        </div>
                    ...
                    <div className='write-body-option-address'>
                        <div className='write-body-option-address-name-box'>
                            <div className='write-body-option-address-name'>상세주소</div>
                        </div>
